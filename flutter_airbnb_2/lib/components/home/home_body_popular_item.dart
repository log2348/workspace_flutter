...
class HomeBodyPopularItem extends StatelessWidget {
  ...
  _buildPopularItemComment() {
    return Column(
      children: [
        Text(
          "깔끔하고 다 갖춰져있어서 좋아요. 위치도 완전 좋아용 다들 여기 살고 싶다고 ㅋㅋㅋㅋ 화장실도 3개에요 !!! 5명이서 씻는 것도 전혀 불편함 없이 좋았어요 ^^ 이불도 포근하고 좋습니다 ㅎㅎㅎㅎ abcdefeeeeeee",
          style: body1(),
          maxLines: 3,
  ...
  Widget _buildPopularItemUserInfo() {
    return Row(
      children: [
        CircleAvatar(
          backgroundImage: const AssetImage("assets/p1.jpeg"),
        ),
        SizedBox(
          width: gap_s,
        ),
